...
if __name__ == "__main__":
    ...
    model_path      = "logs-talimu/last_epoch_weights.pth"
    ...
    Init_Epoch          = 0
    Freeze_Epoch        = 0
    Freeze_batch_size   = 25
   
    UnFreeze_Epoch      = 300
    Unfreeze_batch_size = 25
    ...
    if True:
        ...
        for epoch in range(Init_Epoch, UnFreeze_Epoch):
            ...
            fit_one_epoch(opt,diffusion2,model_train, model, loss_history, eval_callback, optimizer, epoch, epoch_step, epoch_step_val, gen, gen_val, UnFreeze_Epoch, Cuda, \
